...
def getAllImages(path):
    return [os.path.join(path, f) for f in os.listdir(path) if
            f.endswith(".png") or f.endswith(".tif") or f.endswith(".jpg")]


for path in getAllImages(
        "/home/marmf/Deposition images/Images/NewPreProcessing/Median_Aligned_DoF_2_Poly_Detrends_All/Training/"):
    ...
    cv2.imwrite(
        "/home/marmf/Deposition images/Images/NewPreProcessing/Median_Aligned_DoF_2_Poly_Detrends_All/Training CN2sd/Originals/" + name + ".png",
        normimg)
